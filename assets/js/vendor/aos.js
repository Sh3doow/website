!function(e, t) {
    ...
    function O(e) {
        if ("number" == typeof e)
            return e;
        if ("symbol" == typeof (t = e) || t && "object" == typeof t && l.call(t) == i)
            return n;
        var t;
        if ("string" != typeof (e = x(e) ? x(o = "function" == typeof e.valueOf ? e.valueOf() : e) ? o + "" : o : e))
            return 0 === e ? e : +e;
        e = e.replace(a, "");
        var o = s.test(e);
    ...
    function q(e) {
        if ("number" == typeof e)
            return e;
        if ("symbol" == typeof (t = e) || t && "object" == typeof t && "[object Symbol]" == E.call(t))
            return NaN;
        var t;
        if ("string" != typeof (e = A(e) ? A(o = "function" == typeof e.valueOf ? e.valueOf() : e) ? o + "" : o : e))
            return 0 === e ? e : +e;
        e = e.replace(f, "");
        var o = b.test(e);
    ...
    function G(e) {
        return e.forEach(function(e, t) {
            ...
            ,
            a.mirror && n >= r.out && !a.once ? e() : n >= r.in ? o.animated || (i = s,
            (r = a.animatedClassNames) && r.forEach(function(e) {
                return i.classList.add(e)
            }),
            K("aos:in", s),
            o.options.id && K("aos:in:" + o.options.id, s),
            o.animated = !0) : o.animated && !a.once && e()
        })
    }
    function J(e) {
    ...
    function V() {
        var e, r;
        (te = 0 < arguments.length && void 0 !== arguments[0] && arguments[0] ? !0 : te) && (r = oe,
            ...
            e.position = {
                ...
                out: o && function(e, t) {
                    ...
                    var o = Q(e, "anchor")
                      , t = Q(e, "offset", t)
                      , e = e;
                    return o && document.querySelectorAll(o) && (e = document.querySelectorAll(o)[0]),
        ...
        G(ee = e),
        window.addEventListener("scroll", function(e, t, o) {
            var n = !0
              , i = !0;
            if ("function" != typeof e)
                throw new TypeError(y);
            return x(o) && (n = "leading"in o ? !!o.leading : n,
    ...
    return {
        init: function(e) {
            return oe = W(oe, e),
            ee = R(),
            oe.disableMutationObserver || D() || (console.info('\n      aos: MutationObserver is not supported on this browser,\n      code mutations observing has been disabled.\n      You may have to call "refreshHard()" by yourself.\n    '),
            oe.disableMutationObserver = !0),
            oe.disableMutationObserver || H("[data-aos]", X),
            ie(oe.disable) || U() ? ne() : (document.querySelector("body").setAttribute("data-aos-easing", oe.easing),
            ...
            -1 === ["DOMContentLoaded", "load"].indexOf(oe.startEvent) ? document.addEventListener(oe.startEvent, function() {
                V(!0)
            }) : window.addEventListener("load", function() {
                V(!0)
            }),
            "DOMContentLoaded" === oe.startEvent && -1 < ["complete", "interactive"].indexOf(document.readyState) && V(!0),
            window.addEventListener("resize", L(V, oe.debounceDelay, !0)),
            window.addEventListener("orientationchange", L(V, oe.debounceDelay, !0)),
            ee)
        },
        refresh: V,
        refreshHard: X
